...
def load_file(file_name, file_type):
    ...
    if file_type == "labeled":
        path = r"D:\Arai4_Projects\unclassified_clustering_project\unclassified_clustering\ML_Project\data\labeled\movement_scription" + "\\" + file_name
        # change the file path to your directory
    elif file_type == "unlabeled":
        path = r"D:\Arai4_Projects\unclassified_clustering_project\unclassified_clustering\ML_Project\data\unlabeled" + "\\" + file_name
